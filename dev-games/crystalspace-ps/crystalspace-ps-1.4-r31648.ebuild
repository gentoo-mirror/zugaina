...
# $Header: /var/cvsroot/gentoo-x86/dev-games/crystalspace-ps/crystalspace-ps-1.4-r31648.ebuild,v 1.4 2008/11/31 12:00:00 loux.thefuture Exp $
...
src_install() {
	...
	echo "CRYSTAL_CONFIG=${CS_PREFIX}/etc/crystalspace-1.4" > "${T}"/90crystalspace
