...
# $Header: $
# This ebuild comes from http://bugs.gentoo.org/show_bug.cgi?id=258244
# Written by rogge
...
pkg_setup() {
	...
	if ! (use $_pr1 || use $_pr2 || use $_pr3 || use $_pr4 || use $_pr5 || use $_pr6 || use $_pr7); then
...
pkg_postinst() {
	...
	if use amd64; then
		ln -s /usr/lib32/cnijlib /usr/lib32/bjlib
		chown 777 /usr/lib32/bjlib/*
	else
