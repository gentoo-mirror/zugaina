...
MY_NOGRASS="complete_hydlaa_without_grass_by_Hassadria.zip"
SRC_URI="http://dev.gentooexperimental.org/~loux/distfiles/${MY_ART} http://dev.gentooexperimental.org/~loux/distfiles/${MY_DATA} http://dev.gentooexperimental.org/~loux/distfiles/${MY_NOGRASS}"
