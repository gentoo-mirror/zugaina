...
src_install() {
	...
	cat "${FILESDIR}/ejabberd-wrapper-${PN}-2.0.3.template" \
	...
	cat "${FILESDIR}/ejabberdctl-wrapper-${PN}-2.0.3.template" \
		| sed -e "s/\@libdir\@/$(get_libdir)/g" -e "s/\@version\@/${PV}/g" \
		> "${T}/ejabberdctl"
	doexe "${T}/ejabberdctl"

	dodir /var/lib/ejabberd
	newinitd "${FILESDIR}/${PN}-2.0.3.initd" ${PN}
	newconfd "${FILESDIR}/${PN}-2.0.3.confd" ${PN}
