...
MY_P="phonegaim_1.0.2-${PV}.linspire0.13"
...
SRC_URI="http://simon.morlat.free.fr/download/0.12.2/source/linphone-0.12.2.tar.gz
	http://distfiles.zugaina.org/${MY_P}.tar.gz"
S="${WORKDIR}/marlin_build_phonegaim-1.0.2"
RESTRICT="nomirror"
