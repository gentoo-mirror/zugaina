...
SRC_URI="http://secondlife.com/developers/opensource/downloads/2009/03/opensource-drops/slviewer-src-opensource-drops-${PV}.tar.gz
...
RDEPEND=">=x11-libs/gtk+-2
	...
	net-dns/c-ares
	x11-libs/pango
	!nollmozlib? ( >=net-libs/llmozlib2-3.0 )
...
src_unpack() {
	...
	unpack slviewer-src-opensource-drops-${PV}.tar.gz
	...
	epatch "${FILESDIR}"/"${PV}"/${PN}-ndof.patch
	epatch "${FILESDIR}"/"${PV}"/${PN}-mozlib.patch
	...
	rm ${S}/cmake/NDOF.cmake
	touch ${S}/cmake/NDOF.cmake
}
